...
# Lazy import of workflow - only import when actually used
...
from security_service.config import SECURITY_POLICY, SERVICE_VERSION


class SecurityVerificationService:
    """High-level service for file security verification using rule-based scoring"""
    
    def __init__(self):
        """Initialize verification service with rule-based scoring"""
